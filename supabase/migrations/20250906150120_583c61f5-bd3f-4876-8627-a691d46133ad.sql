...
-- Add school_year_id columns to existing tables (nullable first)
...
ALTER TABLE public.payments ADD COLUMN school_year_id UUID REFERENCES public.school_years(id);
ALTER TABLE public.classes ADD COLUMN school_year_id UUID REFERENCES public.school_years(id);
ALTER TABLE public.teachers ADD COLUMN school_year_id UUID REFERENCES public.school_years(id);

-- Update existing records to reference the current school year
...
-- Make school_year_id NOT NULL now that we have data
...
ALTER TABLE public.payments ALTER COLUMN school_year_id SET NOT NULL;
ALTER TABLE public.classes ALTER COLUMN school_year_id SET NOT NULL;
ALTER TABLE public.teachers ALTER COLUMN school_year_id SET NOT NULL;
